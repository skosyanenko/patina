  ...
  return (
      <div className="review">
          ...
          <div className="review__end">
              <img src={require('static/images/author/Golding.png')} alt="" className="review__img"/>
              <div className="review__quote">
                  <img src={require('static/images/icons/black-quote.svg')} alt="" className="review__quote-img"/>
              </div>
