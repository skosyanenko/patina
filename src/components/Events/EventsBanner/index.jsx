      ...
      <div className="banner">
          ...
          <div className="banner__icons">
              <div className="banner__column">
                  ...
                  style={{
                      background: `url(${require('static/images/icons/weather/wi-day-sunny.svg')}) no-repeat 28% top / 65%`
                  }} />
              ...
              <div className="banner__column">
                  <div className="banner__column-icon"
                       style={{
                           background: `url(${require('static/images/icons/weather/wi-strong-wind.svg')}) no-repeat 28% top / 65%`
                       }} />
              ...
              <div className="banner__column">
                  <div className="banner__column-icon"
                       style={{
                           background: `url(${require('static/images/icons/weather/wi-windy.svg')}) no-repeat 28% top / 65%`
                       }} />
              ...
              <div className="banner__pressure">
                  <div className="banner__pressure-icon"
                       style={{
                           background: `url(${require('static/images/icons/weather/wi-thermometer.svg')}) no-repeat 28% top / 65%`
                       }} />
